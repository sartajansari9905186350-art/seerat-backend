...
mobileRouter.get(['/auth/verify-reset-token', '/mobile/auth/verify-reset-token'], (req, res, next) => mobileAuthController.verifyResetToken(req, res, next));
mobileRouter.post(['/auth/reset-password', '/mobile/auth/reset-password'], (req, res, next) => mobileAuthController.resetPassword(req, res, next));
mobileRouter.post('/auth/facebook', (req, res, next) => mobileAuthController.facebookLogin(req, res, next));
...
// Reels (Feed, Create, Upload, Views, Delete)
