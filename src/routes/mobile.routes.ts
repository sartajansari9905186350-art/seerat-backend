...
mobileRouter.get('/auth/verify-reset-token', (req, res, next) => mobileAuthController.verifyResetToken(req, res, next));
mobileRouter.post('/auth/reset-password', (req, res, next) => mobileAuthController.resetPassword(req, res, next));
